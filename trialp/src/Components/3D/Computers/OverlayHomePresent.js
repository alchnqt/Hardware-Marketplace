...
import { useGLTF, MeshReflectorMaterial, BakeShadows, useProgress, Html } from '@react-three/drei'
...
export default function OverlayHomePresent() {
    return (
        <Canvas style={{ height: '700px' }} shadows dpr={[1, 1.5]} camera={{ position: [-1.5, 1, 5.5], fov: 45, near: 1, far: 20 }} eventSource={document.getElementById('root')} eventPrefix="client">
            {/* Lights */}
